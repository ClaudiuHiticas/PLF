% 14. Write a program to generate the list of all subsets of 
% sum S with the elements of a list (S - given).
% Eg: [1,2,3,4,5,6,10] si S=10 => 
...
%allsolutions([1, 2, 3, 4, 5, 5, 10], 10, R).